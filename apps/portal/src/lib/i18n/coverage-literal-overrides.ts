...
export const explicitCoverageLiteralOverrides: Record<string, readonly [string, string]> = {
  ...
  'Timesheet table': ['Tabla de registros de tiempo', 'Tabela de registros de tempo'],
  'Travel budget (minor)': [
  ...
  'Actual time, one week at a glance': [
    'Tiempo real de una semana de un vistazo',
    'Tempo real de uma semana em uma única visão',
  ],
  ...
  'Optional planning context only; actual and approved time remain the source of compensation.': [
    'Solo contexto de planificación opcional; el tiempo real y aprobado sigue siendo la fuente de compensación.',
    'Apenas contexto opcional de planejamento; o tempo real e aprovado continua sendo a fonte da remuneração.',
  ],
  ...
  'Weekly actual time and approval status': [
    'Tiempo real semanal y estado de aprobación',
    'Tempo real semanal e status de aprovação',
  ],
  ...
  'time record(s) have no matching compensation rule and require Finance review.': [
    'Los registros de tiempo no tienen una regla de compensación coincidente y requieren revisión de Finanzas.',
    'Os registros de tempo não têm uma regra de remuneração correspondente e exigem revisão de Finanças.',
  ],
...
export const extractedSectionCoverageOverrides: Record<string, readonly [string, string]> = {
  ...
  'Configure effective billing streams and source rules. Configuration does not create actual time or payments.':
    [
      'Configura flujos de facturación y reglas de origen con fecha de vigencia. La configuración no crea tiempo real ni pagos.',
      'Configure fluxos de faturamento e regras de origem com vigência. A configuração não cria tempo real nem pagamentos.',
    ],
  ...
  'Edit time entry': ['Editar registro de tiempo', 'Editar registro de tempo'],
  ...
  'Filter time entries': ['Filtrar registros de tiempo', 'Filtrar registros de tempo'],
  ...
  'Log time': ['Registrar tiempo', 'Registrar tempo'],
  ...
  'Planning and expected values are directional controls. They never count as actual time, paid cash, or collected revenue.':
    [
      'Los valores planificados y previstos son controles orientativos. Nunca cuentan como tiempo real, efectivo pagado o ingresos cobrados.',
      'Os valores planejados e esperados são controles direcionais. Nunca contam como tempo real, dinheiro pago ou receita recebida.',
    ],
  'Planning context only; actual time remains independently recorded.': [
    'Solo contexto de planificación; el tiempo real se registra de forma independiente.',
    'Somente contexto de planejamento; o tempo real continua registrado de forma independente.',
  ],
  'Planning input only; it never creates actual time': [
    'Solo entrada de planificación; nunca crea tiempo real',
    'Somente entrada de planejamento; nunca cria tempo real',
  ],
  ...
  'Your actual time entries will appear here.': [
    'Tus registros de tiempo real aparecerán aquí.',
    'Seus registros de tempo real aparecerão aqui.',
  ],
  ...
  'Type the exact email to confirm deletion': [
    ...
    'Digite o e-mail exato para confirmar a exclusão',
  ],
