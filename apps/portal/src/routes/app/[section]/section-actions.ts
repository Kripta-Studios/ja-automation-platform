...
export const sectionActions: Actions = {
  ...
  updatePlanning: reportActions.updatePlanning,
  cancelPlanning: reportActions.cancelPlanning,
  ...
  restoreCreditNoteState: billingActions.restoreCreditNoteState,
  ...
  createTimeBatch: timeActions.createTimeBatch,
  ...
  setProjectReimbursementDefault: financeActions.setProjectReimbursementDefault,
