...
const es: ReviewCopy = {
  ...
  followupHelp:
    'Los eventos no se pueden editar ni eliminar. Son privados para el personal y están vinculados a la versión y al hash exactos mostrados.',
  dispatchHelp:
    'Compartido/exportado son registros de envío declarados por el usuario. La aplicación no envía correo al cliente.',
  eventType: 'Tipo de evento',
  shared: 'Compartido',
  exported: 'Exportado',
  awaitingSignatory: 'En espera del firmante designado',
  returned: 'Devuelto',
  disputed: 'Disputado',
  method: 'Método de envío',
  eventDate: 'Fecha de envío',
  reference: 'Referencia de envío',
  signatoryName: 'Firmante designado',
  reason: 'Motivo',
  ...
  requiredForSignatory: 'Obligatorio al esperar un firmante designado.',
  requiredForReturn: 'Obligatorio para eventos devueltos o disputados.',
  pdfRequired: 'Se necesita un PDF actual y listo antes de eventos de envío o firma.',
  dispatchAttestation:
  ...
  reasonLabels: {
    invalid_period_configuration: 'La configuración del período de facturación no es válida.',
    pending_time_correction: 'Hay una corrección de horas pendiente.',
    missing_approved_daily_report: 'Falta un informe diario aprobado.',
    missing_approved_technical_report: 'Falta un informe técnico aprobado.',
    pending_expense_approval: 'Hay un gasto pendiente de aprobación financiera.',
    pending_expense_correction: 'Hay una corrección de gasto pendiente.',
    missing_expense_currency_conversion: 'Falta la conversión de moneda de un gasto.',
    missing_fixed_price: 'Falta el precio fijo.',
    cap_exhausted: 'Se ha alcanzado el límite de facturación configurado.',
    ...
    pending_time_approval: 'Un registro de horas espera aprobación.',
  ...
  followupTypes: {
    shared: 'Compartido',
    exported: 'Exportado',
    awaiting_signatory: 'En espera del firmante designado',
    returned: 'Devuelto',
    disputed: 'Disputado',
  },
};
...
const pt: ReviewCopy = {
  ...
  version: 'Versão da captura',
  hash: 'SHA-256 da captura',
  pdf: 'PDF do cliente',
  ready: 'Pronto',
  ...
  followupHelp:
    'Os eventos não podem ser editados nem excluídos. São privados para a equipe e vinculados à versão e ao hash exatos mostrados.',
  dispatchHelp:
    'Compartilhado/exportado são registros de envio declarados pelo usuário. O aplicativo não envia e-mail ao cliente.',
  eventType: 'Tipo de evento',
  shared: 'Compartilhado',
  exported: 'Exportado',
  awaitingSignatory: 'Aguardando signatário designado',
  returned: 'Devolvido',
  disputed: 'Contestado',
  method: 'Método de envio',
  eventDate: 'Data do envio',
  reference: 'Referência do envio',
  signatoryName: 'Signatário designado',
  reason: 'Motivo',
  ...
  requiredForSignatory: 'Obrigatório ao aguardar um signatário designado.',
  requiredForReturn: 'Obrigatório para eventos devolvidos ou contestados.',
  pdfRequired: 'Um PDF atual e pronto é obrigatório antes de eventos de envio ou assinatura.',
  dispatchAttestation:
  ...
  reasonLabels: {
    invalid_period_configuration: 'A configuração do período de faturamento é inválida.',
    pending_time_correction: 'Há uma correção de horas pendente.',
    missing_approved_daily_report: 'Falta um relatório diário aprovado.',
    missing_approved_technical_report: 'Falta um relatório técnico aprovado.',
    pending_expense_approval: 'Há uma despesa aguardando aprovação financeira.',
    pending_expense_correction: 'Há uma correção de despesa pendente.',
    missing_expense_currency_conversion: 'Falta a conversão de moeda de uma despesa.',
    missing_fixed_price: 'Falta o preço fixo.',
    cap_exhausted: 'O limite de faturamento configurado foi atingido.',
    ...
    pending_time_approval: 'Um registro de horas aguarda aprovação.',
  ...
  followupTypes: {
    shared: 'Compartilhado',
    exported: 'Exportado',
    awaiting_signatory: 'Aguardando signatário designado',
    returned: 'Devolvido',
    disputed: 'Contestado',
  },
};
