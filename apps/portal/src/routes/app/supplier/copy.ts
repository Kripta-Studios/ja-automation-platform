...
export const supplierCopy = {
  en: {
    ...
    batchHoursLegend: 'Hours for the selected technicians',
    sharedHours: 'Same hours for everyone',
    individualHours: 'Different hours for each person',
    personHours: 'hours',
    date: 'Work date',
    category: 'Category',
    work: 'Work',
    ...
    breakHours: 'Break (decimal hours)',
    invalidBreakHours: 'Enter a valid break in decimal hours, shorter than 24 hours.',
    ...
    discardConfirm: 'Discard this unsubmitted draft? Its audit history will remain.',
  ...
  es: {
    ...
    teamHours: 'horas del equipo',
    batchHoursLegend: 'Horas de los técnicos seleccionados',
    sharedHours: 'Las mismas horas para todos',
    individualHours: 'Horas diferentes para cada persona',
    personHours: 'horas',
    ...
    breakHours: 'Descanso (horas decimales)',
    invalidBreakHours: 'Introduce un descanso válido en horas decimales, inferior a 24 horas.',
    ...
    discardConfirm: '¿Descartar este borrador sin enviar? Se conservará su historial de auditoría.',
  ...
  pt: {
    ...
    teamHours: 'horas da equipe',
    batchHoursLegend: 'Horas dos técnicos selecionados',
    sharedHours: 'As mesmas horas para todos',
    individualHours: 'Horas diferentes para cada pessoa',
    personHours: 'horas',
    ...
    breakHours: 'Intervalo (horas decimais)',
    invalidBreakHours: 'Informe um intervalo válido em horas decimais, inferior a 24 horas.',
    ...
    discardConfirm: 'Descartar este rascunho não enviado? O histórico de auditoria será mantido.',
