...
| 33 immutable PDFs and traceability                             | `packages/reporting/src/exports.ts`, stable artifact jobs, invoice PDF route, immutable EN/PT-BR/ES locale snapshots; `tests/reporting-artifacts.test.ts`, `tests/integration/invoice-lifecycle.test.ts` |
