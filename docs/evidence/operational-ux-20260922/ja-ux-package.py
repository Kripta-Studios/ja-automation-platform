...
archive=stage/'jaautomation-operational-ux-20260922.zip';prefix='jaautomation-operational-ux/'
...
pathlib.Path('/tmp/ja-ux-release-receipt.json').write_text(json.dumps(receipt,indent=2)+'\n')
