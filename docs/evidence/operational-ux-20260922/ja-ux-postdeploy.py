...
repo=Path('/home/kripta/ja-automation-platform-vps-hotfix');out=repo/'docs/evidence/operational-ux-20260922'
receipt=json.loads(Path('/tmp/ja-ux-release-receipt.json').read_text())
