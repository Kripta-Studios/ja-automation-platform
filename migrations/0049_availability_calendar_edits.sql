...
ALTER TABLE migration_contract_metadata RENAME TO migration_contract_metadata_v48;
CREATE TABLE migration_contract_metadata(
  migration_version INTEGER PRIMARY KEY CHECK(migration_version BETWEEN 19 AND 49),
...
INSERT INTO migration_contract_metadata SELECT * FROM migration_contract_metadata_v48;
...
DROP TABLE migration_contract_metadata_v48;
...
-- Allow the reviewed availability update audit without rewriting existing events.
...
INSERT INTO audit_action_registry(contract_version,action,entity_type,actor_kind,owner_packet,data_classification) VALUES
  ('B5-R4','worker_availability.update','worker_availability','user','CE-CORE02','restricted');
