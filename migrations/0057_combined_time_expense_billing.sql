...
ALTER TABLE migration_contract_metadata RENAME TO migration_contract_metadata_v56;
CREATE TABLE migration_contract_metadata(
  migration_version INTEGER PRIMARY KEY CHECK(migration_version BETWEEN 19 AND 57),
  migration_name TEXT NOT NULL UNIQUE CHECK(migration_name IN(
    ...
    'expense_occurrence_time_shift_link','crew_leader_time','crew_expense_recorder','assignment_commercial_fallback','assignment_expense_policy','operational_time_expense_request','crew_shared_expense_allocation','combined_time_expense_billing'
  )),
...
INSERT INTO migration_contract_metadata SELECT * FROM migration_contract_metadata_v56;
...
DROP TABLE migration_contract_metadata_v56;
...
ALTER TABLE billing_rule ADD COLUMN include_expenses INTEGER NOT NULL DEFAULT 0 CHECK(include_expenses IN (0,1));
