-- Admit an audited correction for an automatically overdue negative credit note.
...
ALTER TABLE migration_contract_metadata RENAME TO migration_contract_metadata_v61;
CREATE TABLE migration_contract_metadata(
  migration_version INTEGER PRIMARY KEY CHECK(migration_version BETWEEN 19 AND 62),
...
INSERT INTO migration_contract_metadata SELECT * FROM migration_contract_metadata_v61;
...
DROP TABLE migration_contract_metadata_v61;
...
INSERT INTO audit_action_registry(contract_version,action,entity_type,actor_kind,owner_packet,data_classification) VALUES
  ('B5-R4','invoice.credit_note_overdue_repair','invoice','user','WP-B5','restricted');
