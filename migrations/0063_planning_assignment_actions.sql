...
ALTER TABLE migration_contract_metadata RENAME TO migration_contract_metadata_v62;
CREATE TABLE migration_contract_metadata(
  migration_version INTEGER PRIMARY KEY CHECK(migration_version BETWEEN 19 AND 63),
...
INSERT INTO migration_contract_metadata SELECT * FROM migration_contract_metadata_v62;
...
DROP TABLE migration_contract_metadata_v62;
...
INSERT INTO audit_action_registry(contract_version,action,entity_type,actor_kind,owner_packet,data_classification) VALUES
  ('B5-R4','planning.update','planning_assignment','user','WP-B5','confidential'),
  ('B5-R4','planning.cancel','planning_assignment','user','WP-B5','confidential');
