-- Register reviewed audit actions for audited correction draft withdrawal.
...
ALTER TABLE migration_contract_metadata RENAME TO migration_contract_metadata_v64;
CREATE TABLE migration_contract_metadata(
  migration_version INTEGER PRIMARY KEY CHECK(migration_version BETWEEN 19 AND 65),
...
INSERT INTO migration_contract_metadata SELECT * FROM migration_contract_metadata_v64;
...
DROP TABLE migration_contract_metadata_v64;
...
INSERT INTO audit_action_registry(contract_version,action,entity_type,actor_kind,owner_packet,data_classification) VALUES
  ('B5-R4','correction.withdraw','time_entry','user','WP-B5','confidential'),
  ('B5-R4','correction.withdraw','expense','user','WP-B5','restricted'),
  ('B5-R4','correction.withdraw','daily_report','user','WP-B5','confidential'),
  ('B5-R4','correction.withdraw','technical_report','user','WP-B5','confidential');
