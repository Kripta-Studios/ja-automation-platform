...
export const projectCloseoutRevisions = sqliteTable('project_closeout_revision', {
  ...
  state: text('state').notNull(),
  internalSnapshotJson: text('internal_snapshot_json').notNull(),
  clientSnapshotJson: text('client_snapshot_json').notNull(),
  clientSelectionJson: text('client_selection_json').notNull(),
  internalSnapshotSha256: text('internal_snapshot_sha256').notNull(),
  clientSnapshotSha256: text('client_snapshot_sha256').notNull(),
  clientConfirmationHash: text('client_confirmation_hash'),
