...
import amazonLogo from '@/public/brand/clients/amazon.webp';
...
import mercadoLibreLogo from '@/public/brand/clients/mercado-libre.webp';
...
import shopeeLogo from '@/public/brand/clients/shopee.webp';
  ...
  return (
    <section id="clients" className="border-y border-ja-line bg-ja-surface py-16 lg:py-20">
      <div className="container-ja">
        ...
        <div className="grid grid-cols-2 gap-px overflow-hidden rounded-[14px] border border-ja-line bg-ja-line p-px sm:grid-cols-3 lg:grid-cols-5">
